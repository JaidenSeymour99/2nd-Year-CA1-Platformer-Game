class HelpScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.platforms.create(this.scaleH * .4, this.scaleH * .98, 'Ground')

        this.platforms.create(this.scaleH, this.scaleW * .5, 'Platform').setScale(.05).refreshBody();

        this.platforms.create(this.scaleH * .5, this.scaleW * .5, 'Platform').setScale(.05).refreshBody();

        this.platforms.create(this.scaleH * .3, this.scaleW * .35, 'Platform').setScale(.05).refreshBody();

        this.platforms.create(this.scaleH * 1.1, this.scaleW * .35, 'Platform').setScale(.5).refreshBody();
